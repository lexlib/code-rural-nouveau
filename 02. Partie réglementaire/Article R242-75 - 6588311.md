...
Lors de son installation ou en cas de changement d'adresse, le vétérinaire peut, dans un délai de deux mois, en informer le
public dans quatre publications de son choix. Il ne peut être publié plus de trois insertions dans chacune d'elles.
...
Elle doit être déposée quinze jours avant sa parution auprès du conseil régional de l'ordre, qui en vérifiera la conformité
avec les règles déontologiques.

En cas de changement de domicile, l'indication du nouveau domicile peut figurer à l'emplacement de l'ancien pendant douze
mois.
