...
La délivrance du permis d'armement est subordonnée à la présentation d'un permis de mise en exploitation des navires de pêche
professionnelle lorsque celui-ci est exigible. Il est procédé au retrait du permis d'armement dans le cas d'une modification
de capacité de capture du navire faite sans qu'ait été obtenu le permis de mise en exploitation des navires de pêche
